...
1. **Quadratic Complexity O(N²)**: The attention mechanism compares every token to every other token. Doubling the context length quadruples the compute cost. This makes infinite context windows extremely expensive.
